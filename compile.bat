...
if %errorlevel% neq 0 exit
echo Linkar Juego
sdcc -o msb.ihx -mz80 --no-std-crt0 --data-loc 0xC000 -Wl-b_BANK2=0x8000 -Wl-b_BANK3=0x8000 crt0_sms.rel game.rel montylib.rel gamelogic.rel resources.rel spriteengine.rel SMSlib.lib PSGLib.rel bank2.rel bank3.rel
if %errorlevel% neq 0 exit
