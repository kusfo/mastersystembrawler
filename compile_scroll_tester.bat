...
if %errorlevel% neq 0 exit
echo Linkar Tester
sdcc -o scrolltester.ihx -mz80 --no-std-crt0 --data-loc 0xC000 -Wl-b_BANK2=0x8000 -Wl-b_BANK3=0x8000 crt0_sms.rel scrolltester.rel SMSlib.lib GSLib.rel bank2.rel bank3.rel
if %errorlevel% neq 0 exit
